...
typedef enum
{
  Te_MainState_Manager_Idle,        
  Te_MainState_Manager_Init,           
     
  Te_MainState_Manager_CookRice,      
  Te_MainState_Manager_WashClothes, 
  Te_MainState_Manager_PreSlogan,
  Te_MainState_Manager_Slogan,
  Te_MainState_Manager_Terminate,
  
  Te_MainState_Manager_Count,
} Te_MainState_Manager;

typedef enum
{
  Te_MainState_A_Idle, 
  Te_MainState_A_Init,    
  Te_MainState_A_Terminate, 
  Te_MainState_A_BoilWater,   
  Te_MainState_A_WashClothes,
  Te_MainState_A_PreSloganOne,
  Te_MainState_A_SloganOne, 
...
typedef enum
{
  Te_MainState_B_Idle,     
  Te_MainState_B_Init,   
  Te_MainState_B_Terminate,  
  Te_MainState_B_WashRice,    
  Te_MainState_B_DryClothes, 
  Te_MainState_B_PreSloganTwo,
  Te_MainState_B_SloganTwo,  
...
typedef enum
{
  Te_MainState_C_Idle,       
  Te_MainState_C_Init,          
  Te_MainState_C_Terminate,       
  Te_MainState_C_CookRice,          
  Te_MainState_C_CollectClothes, 
  Te_MainState_C_PreSloganThree,
  Te_MainState_C_SloganThree,       
...
typedef struct
{
  ...
  const char									state_name[10][10];//[module id][name length]

...
int InitProcess_SSM()
{
  ...
  SSM_LOG(Te_AppLogLevel_DEBUG, "InitProcess_SSM\n");
  
  /*init rte by analysis user config*/
  InitModuleDepend();
  SSM_LOG(Te_AppLogLevel_DEBUG, "InitModuleDepend end\n");
  InitModuleStateType();
  SSM_LOG(Te_AppLogLevel_DEBUG, "InitModuleStateType end\n");
  InitModuleHeartBeatState();
  SSM_LOG(Te_AppLogLevel_DEBUG, "InitModuleHeartBeatState end\n");
...
{
  int result = Te_workPerformanceResult_Succ;
  SSM_LOG(Te_AppLogLevel_DEBUG, "TerminateProcess_SSM\n");
  return result;
}
/*********************************************/
...
int ModuleStateCheckAll_SSM()
{
  ...
  SSM_LOG(Te_AppLogLevel_DEBUG, "ModuleStateCheckAll_SSM\n");
